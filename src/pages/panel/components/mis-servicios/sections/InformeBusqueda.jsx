    ...
    <section className="border border-neutral-200 rounded-2xl bg-white shadow-sm overflow-hidden">
      ...
      <div className="px-6 pt-5 pb-4 border-b border-neutral-100">
        <div className="flex items-center gap-2 mb-1">
          ...
          <h3 className="text-base font-bold text-neutral-900">Informe de búsqueda de másteres</h3>
        </div>
        <p className="text-sm text-neutral-500 ml-9">
          Tu asesor subirá aquí el informe con los másteres recomendados para tu perfil.
        </p>
      </div>
          ...
          <div className="flex items-start gap-3 bg-neutral-50 border border-neutral-200 rounded-xl p-4">
            ...
            <div>
              ...
              <p className="text-sm text-neutral-500 mt-0.5">
                Tu asesor lo subirá cuando esté listo. Te avisaremos.
              </p>
            </div>
          </div>
        ) : (
