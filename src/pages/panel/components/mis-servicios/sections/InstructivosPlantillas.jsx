    ...
    <section className="border border-neutral-200 rounded-2xl bg-white shadow-sm overflow-hidden">
      ...
      <div className="px-6 pt-5 pb-4 border-b border-neutral-100">
        <div className="flex items-center gap-2 mb-1">
          ...
          <h3 className="text-base font-bold text-neutral-900">Instructivos y plantillas</h3>
        </div>
        <p className="text-sm text-neutral-500 ml-9">Descarga la guía paso a paso de tu servicio.</p>
      </div>
