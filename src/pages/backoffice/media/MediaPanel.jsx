  ...
  return (
    <div className="p-4 sm:p-6 max-w-6xl mx-auto space-y-5">
      ...
      <div>
        ...
        <p className="text-sm text-neutral-500">Imágenes para correos electrónicos — alojadas en el servidor.</p>
      </div>
      ...
      <div className="bg-sky-50 border border-sky-200 rounded-xl px-4 py-3 text-xs text-sky-700 flex items-start gap-2">
        ...
        <span>
          Las imágenes se guardan en el servidor y las sirve directamente Nginx.
          Copia la URL de cualquier imagen y úsala en el editor de correos.
        </span>
      </div>
